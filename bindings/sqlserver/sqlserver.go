...
// SQLServer represents SQLServer output binding
type SQLServer struct {
	logger logger.Logger
	db     *pgxpool.Pool
}

var _ = bindings.OutputBinding(&SQLServer{})

// NewSQLServer returns a new SQLServer output binding
func NewSQLServer(logger logger.Logger) *SQLServer {
	return &SQLServer{logger: logger}
}

// Init initializes the SQLServer binding
func (p *SQLServer) Init(metadata bindings.Metadata) error {
...
// Operations returns list of operations supported by SQLServer binding
func (p *SQLServer) Operations() []bindings.OperationKind {
...
func (p *SQLServer) Invoke(req *bindings.InvokeRequest) (resp *bindings.InvokeResponse, err error) {
	if req == nil {
...
func (p *SQLServer) query(sql string) (result []byte, err error) {
...
func (p *SQLServer) exec(sql string) (result int64, err error) {
